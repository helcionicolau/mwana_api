...
// Diretório de upload para imagens dos especialistas
const uploadDir = path.join(__dirname, '../uploads/especialistas');
...
const uploadEspecialistaImagem = multer({
  storage,
...
module.exports = { uploadEspecialistaImagem, handleMulterErrors };
