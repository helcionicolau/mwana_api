...
// Diretório de upload para logos dos parceiros
const uploadDir = path.join(__dirname, '../uploads/parceiros');
...
const uploadParceiroLogo = multer({
  storage,
...
module.exports = { uploadParceiroLogo, handleMulterErrors };
