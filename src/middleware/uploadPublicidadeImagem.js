...
// Diretório de upload para imagens de publicidades
const uploadDir = path.join(__dirname, '../uploads/publicidades');
...
const uploadPublicidadeImagem = multer({
  storage,
...
module.exports = { uploadPublicidadeImagem, handleMulterErrors };
