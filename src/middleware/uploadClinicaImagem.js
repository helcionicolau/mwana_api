...
// Diretório de upload para imagens das clínicas
const uploadDir = path.join(__dirname, '../uploads/clinicas_instituicoes');
...
const uploadClinicaImagem = multer({
  storage,
...
module.exports = { uploadClinicaImagem, handleMulterErrors };
